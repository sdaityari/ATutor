<?php
    ...
    //install module by running sql!
    //XXX Check other modules to show success and error messages
 ...
 */
$_course_privilege = FALSE; // possible values: FALSE | AT_PRIV_ADMIN | TRUE
$_admin_privilege  = TRUE; // possible values: FALSE | TRUE
//$_cron_interval    = 0; // run every 30 minutes
...
// Not sure whether to create directories

/*$directory = AT_CONTENT_DIR .'api';
